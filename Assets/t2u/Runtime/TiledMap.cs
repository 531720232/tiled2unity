...
namespace Tiled2Unity
{
    public class TiledMap : MonoBehaviour
    {
        ...
        public TmxMap.MapOrientation Orientation = TmxMap. MapOrientation.Orthogonal;
        public TmxMap.MapStaggerAxis StaggerAxis = TmxMap.MapStaggerAxis.X;
        public TmxMap.MapStaggerIndex StaggerIndex = TmxMap.MapStaggerIndex.Odd;
        ...
        public bool AreTilesStaggered()
        {
            ...
            return this.Orientation == TmxMap.MapOrientation.Staggered || this.Orientation == TmxMap.MapOrientation.Hexagonal;
        }
